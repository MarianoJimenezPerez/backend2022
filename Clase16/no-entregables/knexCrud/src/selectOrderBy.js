...
knex.from('autos').select('*').where('marca', '=', 'audi').orderBy('id', 'desc')  //envío con el método where, algún requisito de búsqueda y ordeno con el metodo orderBy por id descendiente
